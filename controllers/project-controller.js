...
function ProjectController() {
  this.create_express = function (req, res) {
    var workitem_types = [],
      db_client,
      project_id,
      res_obj = [];
  ...
  this.select_by_id = function (req, res) {
    var db_client = {};
  ...
  this.add_module = function (req, res) {
    var db_client,
  ...
  this.remove_module = function (req, res) {
    var db_client,
  ...
  this.get_modules = function (req, res) {
    var db_client;
    db.acquire(function (err, client) {
      db_client = client;
      get_modules();
  ...
  this.get_workitem_details = function (req, res) {
    var db_client,
      workitem_types = [];
    db.acquire(function (err, client) {
      db_client = client;
  ...
  this.add_workitem_type = function (req, res) {
    var db_client;
  ...
  this.remove_workitem_type = function (req, res) {
    var db_client;
  ...
  this.update_workitem_type = function (req, res) {
    var db_client;
  ...
  this.add_workitem_state = function (req, res) {
    var db_client;
  ...
  this.update_workitem_state = function (req, res) {
    var db_client;
    ...
    db.acquire(function (err, client) {
      db_client = client;
      var args = [req.params.workitem_state_id, req.params.workitem_id, req.params.workitem_state_title];
      db_client.query(sp.get_sp(sp.insert_workitem_state, args), send_response);
    });
  };

  this.remove_workitem_state = function (req, res) {
    var db_client;
  ...
  this.set_final_workitem_state = function (req, res) {
    var db_client;
